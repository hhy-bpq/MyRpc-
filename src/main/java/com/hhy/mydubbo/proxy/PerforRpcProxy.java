...
import com.hhy.mydubbo.client.PerforClient;
 ...
 * @Date:2017/12/7
 */
public class PerforRpcProxy {

    private static final Logger LOGGER = LoggerFactory.getLogger(PerforRpcProxy.class);

    private String  url;

//    private ServiceDiscovery serviceDiscovery;

    public PerforRpcProxy(String url) {
        this.url = url;
    }
...
//                        // 创建 RPC 客户端对象并发送 RPC 请求
                        PerforClient client = new PerforClient(url,request);
