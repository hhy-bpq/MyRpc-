 ...
 * @Date:2017/12/7
 */
public class LonConRpcProxy {

    private static final Logger LOGGER = LoggerFactory.getLogger(LonConRpcProxy.class);

    private String  url;

//    private ServiceDiscovery serviceDiscovery;

    public LonConRpcProxy(String url) {
        this.url = url;
    }
        ...
        return (T) Proxy.newProxyInstance(
                ...
                new InvocationHandler() {
                    ...
                    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                        ...
                        request.setId(RandomUtils.nextLong(0,1000));
