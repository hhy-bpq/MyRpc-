 ...
 * @Date:2017/12/7
 */
public class LonConClientTest2 {

    private static final Logger LOGGER = LoggerFactory.getLogger(LonConClientTest2.class);
...
//        LOGGER.info("time: {}ms",t1);
        ...
        while (true){
            ...
            String url= "127.0.0.1:9020";
            LonConRpcProxy2 rpcProxy =new LonConRpcProxy2(url);
