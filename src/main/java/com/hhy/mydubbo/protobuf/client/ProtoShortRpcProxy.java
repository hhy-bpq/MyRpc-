 ...
 * @Date:2017/12/7
 */
public class ProtoShortRpcProxy {

    private static final Logger LOGGER = LoggerFactory.getLogger(ProtoShortRpcProxy.class);
...
//    private ServiceDiscovery serviceDiscovery;
    ...
    public ProtoShortRpcProxy(String url) {
        this.url = url;
    }
...
//                        // 创建 RPC 客户端对象并发送 RPC 请求
                        ProtoShortClient client = new ProtoShortClient(url,request.build());
